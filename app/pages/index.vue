...
useSeoMeta({
    ...
    ogImage: "https://img.blog.ashcolor.jp/img/pc/2025-12-10_22-25-37_bngk8eai.webp",
...
<template>
    <ProseH1 class="my-4 text-center text-4xl">{{ BLOG_TITLE }}</ProseH1>
    <div class="text-center text-slate-500">
        <p>{{ BLOG_SUBTITLE }}</p>
    </div>
    <div
        class="hero mx-[calc(50%_-_50vw)] my-8 h-[50vh] w-screen bg-[url('https://img.blog.ashcolor.jp/img/pc/2025-12-10_22-25-37_bngk8eai.webp')]"
    >
