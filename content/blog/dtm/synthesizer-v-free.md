...
title: "SynthV Studio Basic、ライト版・機能制限版について"
...
Synthesizer Vは無料でダウンロードすることができる、**ライト版**と**機能限定版**の歌声データベースを数多く配布しています。

### ライト版・機能限定版の歌声データベース一覧

現在（2024年5月）配布されているライト版・機能限定版の歌声データベースは以下の通りです。
...
一方で、ライト版とは異なりレンダリングモードを自由に選択できるため、[高音質な歌声]{.marker}を出力することができます。
