...
[試用期限や時間の制限はなく]{.marker}、基本的な機能を使用できます。
...
| 必須<br>記載事項   | ライト版の使用を明記する必要あり | なし                                                                                                                             |
...
:custom-audio{title="Saki 製品版 ver.127" src="https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/audio/dtm_synthesizer-v-free_normal.mp3"}

:custom-audio{title="Saki ライト版 ver.100" src="https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/audio/dtm_synthesizer-v-free_light.mp3"}
...
ただし、機能限定版を配布している歌声データベースは限られるため、上記の一覧で確認してみてください。
