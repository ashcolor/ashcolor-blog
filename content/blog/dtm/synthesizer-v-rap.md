...
![ノートプロパティ ピッチモードにラップ追加](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/dtm_synthesizer-v-rap_setting.webp)

ノートを**ラップ**モードにすると[ラップ用のピッチが生成]{.marker}されます。

![ピッチモードによるピッチの違い（左：歌唱モード、右：ラップモード）](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/dtm_synthesizer-v-rap_rap.webp)
...
![イントネーションによるピッチの変化（左：-5.00、右：+0.500）](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/dtm_synthesizer-v-rap_intonation.webp)

### トーン

**トーン**では、[基準となる音程]{.marker}を設定できます。

![トーンによるピッチの変化（左：-1.000、右：+1.000）](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/dtm_synthesizer-v-rap_tone.webp)
