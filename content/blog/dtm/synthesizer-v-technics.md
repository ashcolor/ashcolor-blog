...
![音素を編集して一部の母音を消した状態](https://img.blog.ashcolor.jp/img/pc/dtm_synthesizer-v-technics_museika1.webp)

母音を消しただけだと、[子音の長さに違和感]{.marker}がある場合があります。
その場合は該当のノートを選択した状態で、[ノートプロパティパネルの**音素**の部分を確認]{.marker}します。

![ノートプロパティ 音素](https://img.blog.ashcolor.jp/img/pc/dtm_synthesizer-v-technics_museika2.webp)
...
:custom-audio{title="無声化前" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_museika_default.mp3"}

:custom-audio{title="無声化後" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_museika_museika.mp3"}
...
:custom-audio{title="テンション：0" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_uragoe_default.mp3"}

:custom-audio{title="テンション：-1.000" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_uragoe_tension.mp3"}
...
:custom-audio{title="ボーカルスタイル：Mai デフォルト" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_uragoe_default.mp3"}

:custom-audio{title="ボーカルスタイル：Mai Soft" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_uragoe_vocal_style.mp3"}
...
:custom-audio{title="トーンシフト：0 cents" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_uragoe_default.mp3"}

:custom-audio{title="トーンシフト：+400 cents" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_uragoe_tone_shift.mp3"}
...
![文字を「'あ」と入力すると音素記号は「cl a」となる](https://img.blog.ashcolor.jp/img/pc/dtm_synthesizer-v-technics_edge.webp)

実際にア行の発音の前に「cl」を付けると、どのようになるのか聞いてみましょう。

:custom-audio{title="clなし" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_edge_default.mp3"}

:custom-audio{title="clあり" src="https://img.blog.ashcolor.jp/audio/dtm_synthesizer-v-technics_edge_edge.mp3"}
