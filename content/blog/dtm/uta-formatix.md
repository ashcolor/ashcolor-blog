...
tags:
  ...
  - "CeVIO AI"
  - "UTAU"
thumbnail: "https://img.blog.ashcolor.jp/img/pc/dtm_uta-formatix_thumbnail.webp"
isRecommend: false
---
...
1. ファイルアップロード領域に変換するファイルをドロップするか、クリックしてファイルを選択します。
   ...
   ![プロジェクトインポート](https://img.blog.ashcolor.jp/img/pc/dtm_uta-formatix_step1.webp)

1. 出力形式を選択します。

   ![出力形式を選ぶ](https://img.blog.ashcolor.jp/img/pc/dtm_uta-formatix_step2.webp)

1. 必要に応じて設定を変更します。（基本的にはそのままで大丈夫です。）
   `次へ`ボタンをクリックします。

   ![設定](https://img.blog.ashcolor.jp/img/pc/dtm_uta-formatix_step3.webp)

1. 処理が完了しました。
   `エクスポート`ボタンをクリックするとファイルをダウンロードすることができます。

   ![エクスポート](https://img.blog.ashcolor.jp/img/pc/dtm_uta-formatix_step4.webp)
