...
ベタ打ちでは不自然な部分を修正するイメージです。

### 調声の例

ベタ打ちの状態と調声をしたときで、[どのように歌が変わるのか最初に聞いてみます]{.marker}。
...
コンプをかけることで、[音量バランスが整って、歌に安定感]{.marker}が出ます。
また、子音が強調されることにより[発音が聞き取りやすくなる効果]{.marker}もあります。

場合によってはマルチバンドコンプをかけると、帯域ごとの音量差がなくなってさらに安定感が増すことがあります。
