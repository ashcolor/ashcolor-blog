...
tags:
  - "キーボード"
  - "キーキャップ"
thumbnail: "https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/gadget_keycap-buy_thumbnail.webp"
isRecommend: true
---
...
この記事では[キーキャップを購入するときの注意点と、Amazonで購入できるオススメのキーキャップを紹介]{.marker}します。
...
![キートップ引き抜き工具 いくつかの形状がある](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/gadget_keycap-buy_key-puller.webp)
...
[シンプルでスタイリッシュなキーキャップは**XVX**]{.marker}、[特定のコンセプトがあってかわいい・かっこいいキーキャップは**Ussixchare**]{.marker}というメーカーがよさそうです。

キーキャップの特徴も表にまとめているので、ぜひお気に入りのキーキャップを見つけてみてください。

### 筆者が使用しているキーキャップ

[私が使用しているお気に入りのキーキャップ]{.marker}を詳しく紹介します。

購入をする際の選定基準は、以下の通りです。

::point-list{title="私のキーキャップの選定基準"}
...
![ミルクミニマリストホワイトテーマ](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/gadget_keycap-buy_milk.webp)

商品画像だとオフホワイトっぽく見えますが、実物は白色に見えます。
[昇華印刷が施されていて品質もよく、読みやすく大きめの印字で視認性も高い]{.marker}です。

本体のキーボードは**CIDOO V65のMoon White**です。
...
![XVX キーキャップセット（ホワイト/グリーン）](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/gadget_keycap-buy_xvx.webp)

[印字形式はダブルショットとなっているため、印字が消える心配もありません]{.marker}。

[サイズ違いのキーが大量にセットになっている]{.marker}ため、様々なサイズのキーボードに対応しています。
さらに、一部のキーは文字色と背景色が逆のキーキャップも付いています。

値段も安価なため、愛用しているメーカーの一つです。

本体のキーボードは**Keychron K6 Pro**です。
Keychron K6 Proのキーキャップも悪くはないですが、[`esc`と`enter`が赤色なのが気に入らなかった]{.marker}ので交換しました。
シンプルな見た目になり、満足しています。
...
この記事では、[キーキャップを購入するときの注意点と、Amazonで購入することができるオススメのキーキャップ]{.marker}を紹介しました。
