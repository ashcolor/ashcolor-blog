...
tags:
  ...
  - "TailwindCSS"
  - "ブログ"
thumbnail: "https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/programming_nuxt-blog_thumbnail.webp"
isRecommend: true
---
...
![NuxtJS](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/programming_nuxt-blog_thumbnail.webp)
...
![daisyUI](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/programming_nuxt-blog_daisyui.webp)
...
一方でVue.jsは、ユーザーインターフェイス構築のためのフレームワークなだけあって、[HTML・CSS・JSが組み合わさったコンポーネントを自由に組み立てることができます]{.marker}。
...
他にも、上記で記載した[VueUse](https://vueuse.org/)や[iconify](https://iconify.design/)を使えば、汎用的な機能やUIを簡潔に記載できるのも便利です。

#### VSCodeで記事を作成できる

![VSCode](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/programming_nuxt-blog_vscode.webp)
...
拡張機能によるチェックはコーディングの際に役立つ場面が多かったですが、ブログのライティングの際も[スペルや文法へ意識を取られることなく記事の内容を考えることに集中できる]{.marker}ため、文章を書くときも便利だと感じました。
...
![WordPressのコメント機能](https://pub-dd46e443a5d24074b8c2dd88f691a324.r2.dev/img/pc/programming_nuxt-blog_comment.webp)
