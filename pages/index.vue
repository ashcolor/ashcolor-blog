...
useSeoMeta({
    ...
    ogImage: "https://d2s4ypph6g1t06.cloudfront.net/img/pc/gadget_desk-tour.avif",
...
<template>
    ...
    <div
        class="hero mx-[calc(50%_-_50vw)] my-8 h-[50vh] w-screen bg-[url('https://d2s4ypph6g1t06.cloudfront.net/img/pc/gadget_desk-tour_overall.avif')]"
    >
